#ifndef DVMARCHINGTABLE_H
#define DVMARCHINGTABLE_H
...
/*!
	\brief
		define marching cube index table, edge
		using static array
*/
...
unsigned char NUMBER_VERTICES[256] = {
	0,
	3,
	3,
	6,
